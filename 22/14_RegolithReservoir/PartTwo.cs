...
internal static class PartTwo
{
    ...
    public static int Solve()
    {
        ...
        gridEndCoords.y += 1;
        gridStartCoords.x = Math.Min(gridStartCoords.x, 500 - gridEndCoords.y);
        gridEndCoords.x = Math.Max(gridEndCoords.x, 500 + gridEndCoords.y);
        ...
        while (grid[sandSourceCoords.y, sandSourceCoords.x] != 'o')
        {
            ...
            while (true)
            {
                ...
                {
                    if (grid[sandCoordinates.y + 1, sandCoordinates.x] == '\0')
                    {
                        ++sandCoordinates.y;
                        continue;
                    }
