...
internal static class PartOne
{
    ...
    // t is the total time which in this case is 30 and p is the number of people which in our case is 1
    public static int Solve()
    {
        ...
        return MaxPressure("AA", valveGraph, 30, 0, 1, new Dictionary<string, int>());
    }
